          ...
          >
            <motion.div variants={fadeInUp}>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 rounded-md border border-gray-300 dark:border-gray-700 bg-black dark:bg-dark focus:ring-2 focus:ring-primary focus:border-transparent"
              />
            </motion.div>
